...
class GlmImagePipeline(DiffusionPipeline):
    ...
    def generate_prior_tokens(
        ...
        # print('inputs["input_ids"].shape[-1]', inputs["input_ids"].shape[-1])
        # print('large_image_offset', large_image_offset)
        # print('token_h', token_h)
        # print('token_w', token_w)
        # print('prior_token_ids_d32.shape', prior_token_ids_d32.shape)
