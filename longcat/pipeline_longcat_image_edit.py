...
from .model_utils import split_quotation, prepare_pos_ids, calculate_shift, retrieve_timesteps, optimized_scale
...
class LongCatImageEditPipeline(
    ...
    def __call__(
        ...
        if prompt_embeds is None and text_ids is None:
            ...
            prompt_embeds, text_ids = self.encode_prompt(prompt, image=image, device=device, dtype=torch.float64)
